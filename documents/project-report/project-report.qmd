...
Event Safety, Sofie Dahl and Christian Sejlund for their time, expertise and knowledge during the analysis, design and implementation phases. Also a big thanks to the rest of Event Safety, Smukfest and Muskelsvindfonden employees for all feedback.
...
The project is going to follow a waterfall method because of the group size and timeframe. The exact timeline can be seen in @sec-appendices. The official project start is in september. Before this we will have prepared the project description, company collaboration, and collected data. September will focus on analysis and design of the system, October and November will contain the implementation phase and the testing will be done in the beginning of December. The project report will be written continuously.
