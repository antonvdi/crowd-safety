...
Scale variation is one of the main challenges with crowd counting, since perspective in the image will lead to different sizes of heads. One solution to this, SASNet, is proposed by @sasnet. SASNet relies on the fact that heads in a local path share roughly the same scale.

Multi-scale fusion for SASNet.

### Transforming and warping matrixes using linear algebra
