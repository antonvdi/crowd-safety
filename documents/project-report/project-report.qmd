...
1. In order for the CSMS to be scalable to (near) real time evaluation performance, it makes sense to limit the use of computing power as much as possible.
