...
For many purposes, a video with a heatmap could be sufficient. However, in order to make it possible to satisfy requirements such as functional requirements 2 and 8 as well as non-functional requirement 2, it was decided to create a simple user interface.
